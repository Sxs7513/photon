...
const LIB_PATH_PREFIX = globalThis.BUILTIN_LIB_PATH_PREFIX
...
function fastLoadBuitInModule (module) {
	const path = `${LIB_PATH_PREFIX}${sep}${module}.js`
	let _module = {
		id: module,
        path: path,
		_failed: null,
	...
	const _mark = '<<SCRIPT>>'
	let _loaderTemplate = `(function _loader (exports, require, module, __filename, __dirname) {${_mark}})(_module.exports, _require, _module, module, module)`
