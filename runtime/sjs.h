...
void JSXHRInit(SJSRuntime* qrt, JSValue ns);

BOOL JSStdInit (SJSRuntime *qrt, JSValue ns);

BOOL JSNetworkInit (SJSRuntime *qrt, JSValue ns);

void JSProcessInit(SJSRuntime *qrt, JSValue ns);
...
void JSInitOS(SJSRuntime* qrt, JSValue ns);
